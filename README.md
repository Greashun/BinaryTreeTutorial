...
* Understand of bash commands
* VSCode (or any code editors that you’re familiar with)
* Latest Node.js 
* Basic understanding of creating constructor functions and methods
...
### Windows
To install Node on Windows please visit the link and download recommended users
Once the exe file has been downloaded go to the download folder.
Once the file is found click the file to install the Node files. 
Follow the instructions from the  to complete the installation.
Revisit step 2 of the process to check node and npm has been installed.


### Mac OSX
To install Node on Mac OSX check to see if you have home brew by typing “which brew”
...
If not please install brew using this following guide (https://docs.brew.sh/Installation).
             ii.     Revist step one of by confirming that brew has been installed.
           iii.     If successful type in “brew install node” without quotes..
            iv.     Revisit step 2 of the process to check node and npm has been installed.


### Linux
To install Node on Linux check to see if you have NVM (Node Version Manager) by typing “nvm --version”.
If the terminal returns “0.34.0” or the latest proceed to the next step. 
If not copy and paste the following code without quotes:
curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.35.3/install.sh | bash
             ii.      Revisit step one to confirm that NVM has been installed. 
            iii.      If successful, type in “nvm install node” without quotes.
            iv.      Revisit step 2 of the process to check node and npm has been installed.
Opening the project with a code editor
With a code editor find the project folder at the directory that it is located. 
...
### Implementing a Node:
    Declare a class with the name “Node”.
    Within the Node class create a constructor method:
...
### Implementing a Binary Search Tree:
    Declare a class with the name “BST”.
    Within the BST class create a constructor method:
    ...
    Declare a new variable called tree:
...
### Implementing Insert Method
    In the BST class create a method called “insert”.
    The insert method will accept one argument that is passed through it. 
    Declare a variable called “newNode” and “currNode”:
    ...
    Check to see if the binary tree has a root:
    If the root’s value  is null initialize the value with the “newNode” and return this.
    Create a while-loop:
...
## Implementing Find Method
    In the BST class create a method called “find”:
...
## Implementing in BST
    In BST class create a method called “preOrder”:
    c.The “preOrder” method will accept two arguments:
    ...
    Once the loop is done return the default array containing all values. 
...
## Implementing in BST
    In BST class create a method called “inOrder”:
    The “inOrder” method will accept two arguments:
    One parameter should pass in the root value.
    Second parameter should pass a default array (e.g. data = [])
        b. Create an if statement:
    Within the statement, check to see if the node isn’t null..
    Create two if statement:
    Check if the current node has a left property:
    ...
    If it does call the “inOrder” method passing in the current node right property and the default array. 
        c. Once the loop is done return the default array containing all values. 
...
### Implementing in BST
    In BST class create a method called “postOrder”:
